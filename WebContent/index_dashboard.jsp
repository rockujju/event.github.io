        ...
        <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card text-white bg-primary o-hidden h-100">
            <div class="card-body">
              ...
              <center><div class="mr-5">Total Registration: 1</div></center>
            </div>
          </div>
        </div>
       ...
       <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card text-white bg-danger o-hidden h-100">
            <div class="card-body">
              ...
              <center><div class="mr-5">Total Participants: 1</div></center>
            </div>
          </div>
        </div>
        <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card text-white bg-success o-hidden h-100">
            <div class="card-body">
              ...
              <center><div class="mr-5">Total Event: 1</div></center>
            </div>
          </div>
        </div>
        <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card text-white bg-warning o-hidden h-100">
            <div class="card-body">
             ...
             <center> <div class="mr-5">Prize amount: 1000</div></center>
            </div>
          </div>
        </div>
